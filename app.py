...
presentation = Presentation("template_new.pptx")
...
# Add the styled table image to the PowerPoint slide
...
# Set the font to Helvetica, font size to 12, and text color to #595959
...
# Add the bar chart image to the PowerPoint slide
...
# Set the font to Helvetica, font size to 16, and text color to #595959
...
# Add the scatter plot image to the PowerPoint slide
